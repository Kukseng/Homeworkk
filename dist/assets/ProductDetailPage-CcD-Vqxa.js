var c=Object.defineProperty;var g=(e,t,r)=>t in e?c(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var s=(e,t,r)=>g(e,typeof t!="symbol"?t+"":t,r);import{A as u}from"./ApiService-BaP9vsO9.js";import{H as i,F as h}from"./Footer-CtBV8ZT6.js";class l{constructor(t){s(this,"product",null);s(this,"loading",!0);s(this,"error",null);s(this,"productId");this.productId=t}async init(){await this.loadProduct(),this.render(),this.addEventListeners()}async loadProduct(){try{this.loading=!0,this.error=null,this.product=await u.fetchProduct(this.productId),this.loading=!1}catch(t){this.error=t instanceof Error?t.message:"An unexpected error occurred",this.loading=!1}}render(){const t=document.getElementById("app");t&&(t.innerHTML=`
      ${i.render()}
      ...
      ${h.render()}
    `,i.addEventListeners(),this.addEventListeners())}renderLoading(){return`
    ...
    `}renderProduct(){return this.product?`
      <!-- Breadcrumb -->
    ...
    `:""}renderStars(t){const r=Math.floor(t),o=t%1>=.5,n=5-r-(o?1:0);let d="";for(let a=0;a<r;a++)d+='<svg class="w-4 h-4 text-yellow-500 dark:text-yellow-400 fill-current" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>';o&&(d+='<svg class="w-4 h-4 text-yellow-500 dark:text-yellow-400" viewBox="0 0 20 20"><defs><linearGradient id="half"><stop offset="50%" stop-color="currentColor"/><stop offset="50%" stop-color="transparent"/></linearGradient></defs><path fill="url(#half)" d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>');for(let a=0;a<n;a++)d+='<svg class="w-4 h-4 text-gray-300 dark:text-gray-600 fill-current" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>';return d}addEventListeners(){}static render(t){new l(t).init()}}export{l as ProductDetailPage};
